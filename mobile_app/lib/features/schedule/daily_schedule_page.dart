              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Wrap(
                    ...
                    children: [
                      _chip(
                        '计划销售额: ${(meta['planTotal'] ?? 0).toString()}',
                        bg: const Color(0xFFEFF6FF),
                        fg: const Color(0xFF2563EB),
                      ),
                      _chip(
                        '总上班时长: ${(meta['laborHoursTotal'] ?? 0).toString()} 小时',
                        bg: const Color(0xFFECFDF5),
                        fg: const Color(0xFF10B981),
                      ),
                      _chip(
                        '人时销售额: ${(meta['salesPerLaborHour'] ?? 0).toString()}',
                        ...
                        for (final it in staff)
                          Builder(
                            builder: (context) {
                              ...
                              final shift =
                                  '${_fmt(m['shiftStart'])}-${_fmt(m['shiftEnd'])}';
