...
class _SettingsPageState extends State<SettingsPage> {
  ...
  final TextEditingController uploadUserAgentCtrl = TextEditingController(text: 'Apifox/1.0.0 (https://apifox.com)');
  bool saving = false;
  ...
  Future<void> _load() async {
    ...
    uploadUserAgentCtrl.text = prefs.getString('external_upload_ua') ?? uploadUserAgentCtrl.text;
  }
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      await prefs.setString('external_upload_cookie', uploadCookieCtrl.text.trim());
      await prefs.setString('external_upload_ua', uploadUserAgentCtrl.text.trim());
      if (!mounted) return;
...
>>>>>>> 3b05955448111a19268705f7739ef747b77bcc6e
